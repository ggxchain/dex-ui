...
declare module "@polkadot/api-base/types/events" {
	interface AugmentedEvents<ApiType extends ApiTypes> {
		accountFilter: {
			AccountAllowed: AugmentedEvent<
				ApiType,
				[account: AccountId32, votedFor: Vec<AccountId32>],
				{ account: AccountId32; votedFor: Vec<AccountId32> }
			>;
			AccountVoted: AugmentedEvent<
				ApiType,
				[referrer: AccountId32, referee: AccountId32],
				{ referrer: AccountId32; referee: AccountId32 }
			>;
			/**
			 * Generic event
		...
		assetRegistry: {
			RegisteredAsset: AugmentedEvent<
				ApiType,
				[assetId: u32, metadata: OrmlTraitsAssetRegistryAssetMetadata],
				{ assetId: u32; metadata: OrmlTraitsAssetRegistryAssetMetadata }
			>;
			UpdatedAsset: AugmentedEvent<
				ApiType,
				[assetId: u32, metadata: OrmlTraitsAssetRegistryAssetMetadata],
				{ assetId: u32; metadata: OrmlTraitsAssetRegistryAssetMetadata }
			>;
		...
		btcRelay: {
			...
			>;
			ForkAheadOfMainChain: AugmentedEvent<
				ApiType,
				[mainChainHeight: u32, forkHeight: u32, forkId: u32],
				{ mainChainHeight: u32; forkHeight: u32; forkId: u32 }
			>;
			Initialized: AugmentedEvent<
				ApiType,
				[blockHeight: u32, blockHash: BitcoinH256Le, relayerId: AccountId32],
				{ blockHeight: u32; blockHash: BitcoinH256Le; relayerId: AccountId32 }
			>;
			StoreForkHeader: AugmentedEvent<
				ApiType,
				[
					chainId: u32,
					forkHeight: u32,
			...
			>;
			StoreMainChainHeader: AugmentedEvent<
				ApiType,
				[blockHeight: u32, blockHash: BitcoinH256Le, relayerId: AccountId32],
				{ blockHeight: u32; blockHash: BitcoinH256Le; relayerId: AccountId32 }
			>;
		...
		clientsInfo: {
			ApplyClientRelease: AugmentedEvent<
				ApiType,
				[release: ClientsInfoClientRelease],
				{ release: ClientsInfoClientRelease }
			>;
			NotifyClientRelease: AugmentedEvent<
				ApiType,
				[release: ClientsInfoClientRelease],
				{ release: ClientsInfoClientRelease }
			>;
		...
		dex: {
			Deposited: AugmentedEvent<
				...
				{ assetId: u32; amount: u128 }
			>;
			NativeDeposited: AugmentedEvent<
				ApiType,
				[amount: u128],
				{ amount: u128 }
			>;
			NativeWithdrawed: AugmentedEvent<
				ApiType,
				[amount: u128],
				{ amount: u128 }
			>;
			OrderCanceled: AugmentedEvent<
				ApiType,
				[orderIndex: u64],
				{ orderIndex: u64 }
			>;
			OrderCreated: AugmentedEvent<
				ApiType,
				[orderIndex: u64, order: PalletDexOrder],
				{ orderIndex: u64; order: PalletDexOrder }
			>;
			OrderTaken: AugmentedEvent<
				ApiType,
				[account: AccountId32, orderIndex: u64, order: PalletDexOrder],
				{ account: AccountId32; orderIndex: u64; order: PalletDexOrder }
			>;
			SubmitProcessedReceipts: AugmentedEvent<
				ApiType,
				[blockNumber: u64],
				{ blockNumber: u64 }
			>;
			Withdrawed: AugmentedEvent<
				ApiType,
				[assetId: u32, amount: u128],
				{ assetId: u32; amount: u128 }
			>;
		...
		eth2Client: {
			...
			>;
			SubmitBeaconChainLightClientUpdate: AugmentedEvent<
				ApiType,
				[
					typedChainId: WebbProposalsHeaderTypedChainId,
			...
			>;
			SubmitExecutionHeader: AugmentedEvent<
				ApiType,
				[
					typedChainId: WebbProposalsHeaderTypedChainId,
			...
			>;
			UpdateTrustedSigner: AugmentedEvent<
				ApiType,
		...
		ethReceiptRegistry: {
			AddedContractAddress: AugmentedEvent<
				ApiType,
				[
					typedChainId: WebbProposalsHeaderTypedChainId,
			...
			>;
			RemovedContractAddress: AugmentedEvent<
				ApiType,
				[
					typedChainId: WebbProposalsHeaderTypedChainId,
					address: TypesPrimitivesH160,
		...
		ics20Transfer: {
			 ...
			 **/
			TransferNativeToken: AugmentedEvent<
				ApiType,
			 ...
			 **/
			TransferNoNativeToken: AugmentedEvent<
				ApiType,
				[AccountId32, AccountId32, u128]
			>;
		...
		issue: {
			CancelIssue: AugmentedEvent<
				ApiType,
				[issueId: H256, requester: AccountId32, griefingCollateral: u128],
				{ issueId: H256; requester: AccountId32; griefingCollateral: u128 }
			>;
			ExecuteIssue: AugmentedEvent<
				ApiType,
				[
					issueId: H256,
			...
			>;
			IssueAmountChange: AugmentedEvent<
				ApiType,
				[
					issueId: H256,
					amount: u128,
			...
			>;
			IssuePeriodChange: AugmentedEvent<
				ApiType,
				[period: u32],
				{ period: u32 }
			>;
			RequestIssue: AugmentedEvent<
				ApiType,
				[
					issueId: H256,
					requester: AccountId32,
		...
		loans: {
			 ...
			 **/
			ActivatedMarket: AugmentedEvent<
				ApiType,
			 ...
			 **/
			DepositCollateral: AugmentedEvent<
				ApiType,
				[
					accountId: AccountId32,
					currencyId: InterbtcPrimitivesCurrencyId,
			 ...
			 **/
			DistributedBorrowerReward: AugmentedEvent<
				ApiType,
				[
					underlyingCurrencyId: InterbtcPrimitivesCurrencyId,
			 ...
			 **/
			DistributedSupplierReward: AugmentedEvent<
				ApiType,
				[
					underlyingCurrencyId: InterbtcPrimitivesCurrencyId,
			 ...
			 **/
			IncentiveReservesReduced: AugmentedEvent<
				ApiType,
				[
			 ...
			 **/
			InterestAccrued: AugmentedEvent<
				ApiType,
				[
					underlyingCurrencyId: InterbtcPrimitivesCurrencyId,
					totalBorrows: u128,
			 ...
			 **/
			LiquidatedBorrow: AugmentedEvent<
				ApiType,
				[
			 ...
			 **/
			MarketRewardSpeedUpdated: AugmentedEvent<
				ApiType,
				[
					underlyingCurrencyId: InterbtcPrimitivesCurrencyId,
			 ...
			 **/
			ReservesReduced: AugmentedEvent<
				ApiType,
				[
					receiver: AccountId32,
					currencyId: InterbtcPrimitivesCurrencyId,
			 ...
			 * Reward added
			 **/
			RewardAdded: AugmentedEvent<
				ApiType,
				[payer: AccountId32, amount: u128],
				{ payer: AccountId32; amount: u128 }
			>;
			/**
			 ...
			 **/
			WithdrawCollateral: AugmentedEvent<
				ApiType,
				[
					accountId: AccountId32,
					currencyId: InterbtcPrimitivesCurrencyId,
		...
		nomination: {
			...
			>;
			NominationOptIn: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId],
				{ vaultId: InterbtcPrimitivesVaultId }
			>;
			NominationOptOut: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId],
				{ vaultId: InterbtcPrimitivesVaultId }
			>;
		...
		oracle: {
			AggregateUpdated: AugmentedEvent<
				ApiType,
				[values: Vec<ITuple<[InterbtcPrimitivesOracleKey, Option<u128>]>>],
				{ values: Vec<ITuple<[InterbtcPrimitivesOracleKey, Option<u128>]>> }
			>;
			/**
			 * Event emitted when exchange rate is set
			 **/
			FeedValues: AugmentedEvent<
				ApiType,
				[
					oracleId: AccountId32,
					values: Vec<ITuple<[InterbtcPrimitivesOracleKey, u128]>>,
				],
				{
					oracleId: AccountId32;
					values: Vec<ITuple<[InterbtcPrimitivesOracleKey, u128]>>;
			...
			>;
			OracleAdded: AugmentedEvent<
				ApiType,
				[oracleId: AccountId32, name: Bytes],
				{ oracleId: AccountId32; name: Bytes }
			>;
			OracleRemoved: AugmentedEvent<
				ApiType,
				[oracleId: AccountId32],
				{ oracleId: AccountId32 }
			>;
		...
		redeem: {
			...
			>;
			LiquidationRedeem: AugmentedEvent<
				ApiType,
				[redeemer: AccountId32, amount: u128],
				{ redeemer: AccountId32; amount: u128 }
			>;
			MintTokensForReimbursedRedeem: AugmentedEvent<
				ApiType,
				[redeemId: H256, vaultId: InterbtcPrimitivesVaultId, amount: u128],
				{ redeemId: H256; vaultId: InterbtcPrimitivesVaultId; amount: u128 }
			>;
			RedeemPeriodChange: AugmentedEvent<
				ApiType,
				[period: u32],
				{ period: u32 }
			>;
			RequestRedeem: AugmentedEvent<
				ApiType,
				[
					redeemId: H256,
					redeemer: AccountId32,
			...
			>;
			SelfRedeem: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, amount: u128, fee: u128],
				{ vaultId: InterbtcPrimitivesVaultId; amount: u128; fee: u128 }
			>;
			/**
			 * Generic event
		...
		replace: {
			...
			>;
			ReplacePeriodChange: AugmentedEvent<
				ApiType,
				[period: u32],
				{ period: u32 }
			>;
			RequestReplace: AugmentedEvent<
				ApiType,
				[
					oldVaultId: InterbtcPrimitivesVaultId,
					amount: u128,
			...
			>;
			WithdrawReplace: AugmentedEvent<
				ApiType,
				[
					oldVaultId: InterbtcPrimitivesVaultId,
		...
		security: {
			...
			UpdateActiveBlock: AugmentedEvent<
				ApiType,
				[blockNumber: u32],
				{ blockNumber: u32 }
			>;
		...
		sessionPayout: {
			Rewarded: AugmentedEvent<
				...
				{ stash: AccountId32; amount: u128 }
			>;
			SessionPayout: AugmentedEvent<
				ApiType,
				[sessionIndex: u32, validatorPayout: u128, remainder: u128],
				{ sessionIndex: u32; validatorPayout: u128; remainder: u128 }
			>;
			YearRewardPoolAllocated: AugmentedEvent<
				ApiType,
				[amount: u128],
				{ amount: u128 }
			>;
		...
		tokens: {
			...
			TotalIssuanceSet: AugmentedEvent<
				ApiType,
				[currencyId: InterbtcPrimitivesCurrencyId, amount: u128],
				{ currencyId: InterbtcPrimitivesCurrencyId; amount: u128 }
			>;
			/**
			 * Transfer succeeded.
		...
		vaultCapacity: {
			DepositStake: AugmentedEvent<
				ApiType,
				[poolId: Null, stakeId: InterbtcPrimitivesCurrencyId, amount: i128],
				{ poolId: Null; stakeId: InterbtcPrimitivesCurrencyId; amount: i128 }
			>;
			DistributeReward: AugmentedEvent<
				ApiType,
				[currencyId: InterbtcPrimitivesCurrencyId, amount: i128],
				{ currencyId: InterbtcPrimitivesCurrencyId; amount: i128 }
			>;
			WithdrawReward: AugmentedEvent<
				...
				[
					poolId: Null,
					stakeId: InterbtcPrimitivesCurrencyId,
					currencyId: InterbtcPrimitivesCurrencyId,
					amount: i128,
				],
				{
		...
		vaultRegistry: {
			BanVault: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, bannedUntil: u32],
				{ vaultId: InterbtcPrimitivesVaultId; bannedUntil: u32 }
			>;
			DecreaseLockedCollateral: AugmentedEvent<
				ApiType,
				[
			...
			>;
			DecreaseToBeIssuedTokens: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, decrease: u128],
				{ vaultId: InterbtcPrimitivesVaultId; decrease: u128 }
			>;
			DecreaseToBeRedeemedTokens: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, decrease: u128],
				{ vaultId: InterbtcPrimitivesVaultId; decrease: u128 }
			>;
			DecreaseToBeReplacedTokens: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, decrease: u128],
				{ vaultId: InterbtcPrimitivesVaultId; decrease: u128 }
			>;
			DecreaseTokens: AugmentedEvent<
				ApiType,
				[
					vaultId: InterbtcPrimitivesVaultId,
					userId: AccountId32,
			...
			>;
			IncreaseLockedCollateral: AugmentedEvent<
				ApiType,
				[
					currencyPair: InterbtcPrimitivesVaultCurrencyPair,
					delta: u128,
			...
			>;
			IncreaseToBeIssuedTokens: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, increase: u128],
				{ vaultId: InterbtcPrimitivesVaultId; increase: u128 }
			>;
			IncreaseToBeRedeemedTokens: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, increase: u128],
				{ vaultId: InterbtcPrimitivesVaultId; increase: u128 }
			>;
			IncreaseToBeReplacedTokens: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, increase: u128],
				{ vaultId: InterbtcPrimitivesVaultId; increase: u128 }
			>;
			IssueTokens: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, increase: u128],
				{ vaultId: InterbtcPrimitivesVaultId; increase: u128 }
			>;
			LiquidateVault: AugmentedEvent<
				ApiType,
				[
					vaultId: InterbtcPrimitivesVaultId,
					issuedTokens: u128,
			...
			>;
			RedeemTokens: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, redeemedAmount: u128],
				{ vaultId: InterbtcPrimitivesVaultId; redeemedAmount: u128 }
			>;
			RedeemTokensLiquidatedVault: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, tokens: u128, collateral: u128],
				{ vaultId: InterbtcPrimitivesVaultId; tokens: u128; collateral: u128 }
			>;
			RedeemTokensLiquidation: AugmentedEvent<
				ApiType,
				[
			...
			>;
			RedeemTokensPremium: AugmentedEvent<
				ApiType,
				[
					vaultId: InterbtcPrimitivesVaultId,
					redeemedAmount: u128,
			...
			>;
			RegisterAddress: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, address: BitcoinAddress],
				{ vaultId: InterbtcPrimitivesVaultId; address: BitcoinAddress }
			>;
			RegisterVault: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, collateral: u128],
				{ vaultId: InterbtcPrimitivesVaultId; collateral: u128 }
			>;
			ReplaceTokens: AugmentedEvent<
				ApiType,
				[
					oldVaultId: InterbtcPrimitivesVaultId,
					newVaultId: InterbtcPrimitivesVaultId,
			...
			>;
			SetAcceptNewIssues: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, acceptNewIssues: bool],
				{ vaultId: InterbtcPrimitivesVaultId; acceptNewIssues: bool }
			>;
			SetCustomSecureThreshold: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, customThreshold: Option<u128>],
				{ vaultId: InterbtcPrimitivesVaultId; customThreshold: Option<u128> }
			>;
			SetLiquidationCollateralThreshold: AugmentedEvent<
				ApiType,
				[currencyPair: InterbtcPrimitivesVaultCurrencyPair, threshold: u128],
				{ currencyPair: InterbtcPrimitivesVaultCurrencyPair; threshold: u128 }
			>;
			SetPremiumRedeemThreshold: AugmentedEvent<
				ApiType,
				[currencyPair: InterbtcPrimitivesVaultCurrencyPair, threshold: u128],
				{ currencyPair: InterbtcPrimitivesVaultCurrencyPair; threshold: u128 }
			>;
			SetSecureCollateralThreshold: AugmentedEvent<
				ApiType,
				[currencyPair: InterbtcPrimitivesVaultCurrencyPair, threshold: u128],
				{ currencyPair: InterbtcPrimitivesVaultCurrencyPair; threshold: u128 }
			>;
			UpdatePublicKey: AugmentedEvent<
				ApiType,
				[accountId: AccountId32, publicKey: BitcoinAddressPublicKey],
				{ accountId: AccountId32; publicKey: BitcoinAddressPublicKey }
			>;
			/**
			 * Generic event
		...
		vaultStaking: {
			...
			>;
			ForceRefund: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId],
				{ vaultId: InterbtcPrimitivesVaultId }
			>;
			IncreaseNonce: AugmentedEvent<
				ApiType,
				[vaultId: InterbtcPrimitivesVaultId, newNonce: u32],
				{ vaultId: InterbtcPrimitivesVaultId; newNonce: u32 }
			>;
			WithdrawReward: AugmentedEvent<
				ApiType,
		...
		whitelist: {
			CallWhitelisted: AugmentedEvent<
				ApiType,
				[callHash: H256],
				{ callHash: H256 }
			>;
			...
			>;
			WhitelistedCallRemoved: AugmentedEvent<
				ApiType,
				[callHash: H256],
				{ callHash: H256 }
			>;
