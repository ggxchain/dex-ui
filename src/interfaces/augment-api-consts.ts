...
declare module "@polkadot/api-base/types/consts" {
	interface AugmentedConsts<ApiType extends ApiTypes> {
		...
		currency: {
			 ...
			 **/
			getNativeCurrencyId: InterbtcPrimitivesCurrencyId &
				AugmentedConst<ApiType>;
			/**
			 * Relay chain currency e.g. DOT/KSM
			 **/
			getRelayChainCurrencyId: InterbtcPrimitivesCurrencyId &
				AugmentedConst<ApiType>;
			/**
			 * Wrapped currency e.g. IBTC/KBTC
			 **/
			getWrappedCurrencyId: InterbtcPrimitivesCurrencyId &
				AugmentedConst<ApiType>;
			/**
			 * Generic const
			 **/
		...
		vaultRegistry: {
			 ...
			 **/
			getGriefingCollateralCurrencyId: InterbtcPrimitivesCurrencyId &
				AugmentedConst<ApiType>;
			/**
