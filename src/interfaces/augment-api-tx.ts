...
declare module "@polkadot/api-base/types/submittable" {
	interface AugmentedSubmittables<ApiType extends ApiTypes> {
		accountFilter: {
			 ...
			 **/
			voteForAccount: AugmentedSubmittable<
				(
					newAccount: AccountId32 | string | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[AccountId32]
			>;
			/**
		...
		assetRegistry: {
			registerAsset: AugmentedSubmittable<
				...
				[OrmlTraitsAssetRegistryAssetMetadata, Option<u32>]
			>;
			updateAsset: AugmentedSubmittable<
				(
					assetId: u32 | AnyNumber | Uint8Array,
					decimals: Option<u32> | null | Uint8Array | u32 | AnyNumber,
					...
					additional:
						...
						| Uint8Array
						| InterbtcPrimitivesCustomMetadata
						| { feePerSecond?: any; coingeckoId?: any }
						| string,
				) => SubmittableExtrinsic<ApiType>,
				[
					u32,
		...
		beefy: {
			...
			reportEquivocation: AugmentedSubmittable<
				...
				[SpConsensusBeefyEquivocationProof, SpSessionMembershipProof]
			>;
			/**
			 * Report voter equivocation/misbehavior. This method will verify the
			 * equivocation proof and validate the given key ownership proof
		...
		btcRelay: {
			 ...
			 **/
			storeBlockHeader: AugmentedSubmittable<
				(
					blockHeader:
						| BitcoinBlockHeader
						| {
						...
						| string
						| Uint8Array,
					forkBound: u32 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[BitcoinBlockHeader, u32]
			>;
			/**
		...
		clientsInfo: {
			 ...
			 **/
			setCurrentClientRelease: AugmentedSubmittable<
				(
					clientName: Bytes | string | Uint8Array,
					release:
						| ClientsInfoClientRelease
						| { uri?: any; checksum?: any }
						| string
						| Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[Bytes, ClientsInfoClientRelease]
			>;
			/**
			 ...
			 * * `release` - The release information for the given `client_name`
			 **/
			setPendingClientRelease: AugmentedSubmittable<
				(
					clientName: Bytes | string | Uint8Array,
					release:
						| ClientsInfoClientRelease
		...
		currencyManager: {
			changeInflationDecay: AugmentedSubmittable<
				(
					newDecay: Perbill | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[Perbill]
			>;
			changeInflationPercent: AugmentedSubmittable<
				(
					newInflation: Perbill | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[Perbill]
			>;
			changeTreasuryCommission: AugmentedSubmittable<
				(
					newCommission: Perbill | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[Perbill]
			>;
			changeTreasuryCommissionFromFee: AugmentedSubmittable<
				(
					newCommission: Perbill | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[Perbill]
			>;
			changeTreasuryCommissionFromTips: AugmentedSubmittable<
				(
					newCommission: Perbill | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[Perbill]
			>;
			yearlyInflationDecay: AugmentedSubmittable<
				() => SubmittableExtrinsic<ApiType>,
				[]
			>;
			/**
		...
		dex: {
			cancelOrder: AugmentedSubmittable<
				(
					orderIndex: u64 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[u64]
			>;
			deposit: AugmentedSubmittable<
				...
				[u32, u128]
			>;
			depositNative: AugmentedSubmittable<
				(
					amount: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[u128]
			>;
			makeOrder: AugmentedSubmittable<
				(
					assetId1: u32 | AnyNumber | Uint8Array,
					assetId2: u32 | AnyNumber | Uint8Array,
					offeredAmount: u128 | AnyNumber | Uint8Array,
					requestedAmount: u128 | AnyNumber | Uint8Array,
					orderType: PalletDexOrderType | "BUY" | "SELL" | number | Uint8Array,
					expirationBlock: u32 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[u32, u32, u128, u128, PalletDexOrderType, u32]
			>;
			takeOrder: AugmentedSubmittable<
				(
					orderIndex: u64 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[u64]
			...
			withdraw: AugmentedSubmittable<
				...
				[u32, u128]
			>;
			withdrawNative: AugmentedSubmittable<
				(
					amount: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[u128]
			...
			init: AugmentedSubmittable<
				(
					...
					args:
						| EthTypesInitInput
						| {
								finalizedExecutionHeader?: any;
								finalizedBeaconHeader?: any;
								currentSyncCommittee?: any;
								nextSyncCommittee?: any;
								validateUpdates?: any;
								verifyBlsSignatures?: any;
								hashesGcThreshold?: any;
								trustedSigner?: any;
						  }
						| string
						| Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[WebbProposalsHeaderTypedChainId, EthTypesInitInput]
			>;
			submitBeaconChainLightClientUpdate: AugmentedSubmittable<
				(
					typedChainId:
						| WebbProposalsHeaderTypedChainId
						| { None: any }
					...
					lightClientUpdate:
						| EthTypesEth2LightClientUpdate
						| {
								attestedBeaconHeader?: any;
								syncAggregate?: any;
								signatureSlot?: any;
								finalityUpdate?: any;
								syncCommitteeUpdate?: any;
						  }
						| string
						| Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[WebbProposalsHeaderTypedChainId, EthTypesEth2LightClientUpdate]
			>;
			submitExecutionHeader: AugmentedSubmittable<
				(
					typedChainId:
						| WebbProposalsHeaderTypedChainId
						| { None: any }
				...
				[WebbProposalsHeaderTypedChainId, EthTypesBlockHeader]
			>;
			updateTrustedSigner: AugmentedSubmittable<
				(
					trustedSigner: AccountId32 | string | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[AccountId32]
			>;
			/**
			...
			submitProof: AugmentedSubmittable<
				(
					typedChainId:
						...
						| string
						| Uint8Array,
					eventProof: Bytes | string | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[WebbProposalsHeaderTypedChainId, Bytes]
			>;
			/**
			 * update ProofDeposit and ProofReward
			 **/
			updateProofFee: AugmentedSubmittable<
				(
					typedChainId:
						| WebbProposalsHeaderTypedChainId
						| { None: any }
						...
						| string
						| Uint8Array,
					proofDeposit: u128 | AnyNumber | Uint8Array,
					proofReward: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[WebbProposalsHeaderTypedChainId, u128, u128]
			>;
			/**
			 * update watching address
			 **/
			updateWatchingAddress: AugmentedSubmittable<
				(
					typedChainId:
						| WebbProposalsHeaderTypedChainId
						| { None: any }
						...
						| string
						| Uint8Array,
					address: TypesPrimitivesH160 | string | Uint8Array,
					add: bool | boolean | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[WebbProposalsHeaderTypedChainId, TypesPrimitivesH160, bool]
			>;
			/**
			 * Generic tx
			 **/
		...
		fee: {
			...
			setCommission: AugmentedSubmittable<
				(
					currencies:
						...
						| string
						| Uint8Array,
					commission: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesVaultCurrencyPair, u128]
			>;
			/**
			 ...
			 * * `fee` - the new fee
			 **/
			setIssueFee: AugmentedSubmittable<
				(fee: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[u128]
			>;
			/**
			 ...
			 **/
			setIssueGriefingCollateral: AugmentedSubmittable<
				(
					griefingCollateral: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[u128]
			>;
			/**
			 ...
			 * * `fee` - the new fee
			 **/
			setPremiumRedeemFee: AugmentedSubmittable<
				(fee: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[u128]
			>;
			/**
			 ...
			 * * `fee` - the new fee
			 **/
			setPunishmentFee: AugmentedSubmittable<
				(fee: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[u128]
			>;
			/**
			 ...
			 * * `fee` - the new fee
			 **/
			setRedeemFee: AugmentedSubmittable<
				(fee: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[u128]
			>;
			/**
			 ...
			 * * `griefing_collateral` - the new griefing collateral
			 **/
			setReplaceGriefingCollateral: AugmentedSubmittable<
				(
					griefingCollateral: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[u128]
			...
			withdrawRewards: AugmentedSubmittable<
				(
					vaultId:
						...
						| string
						| Uint8Array,
					index: Option<u32> | null | Uint8Array | u32 | AnyNumber,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesVaultId, Option<u32>]
			>;
			/**
			 * Generic tx
			 **/
		...
		ibc: {
			...
			deliver: AugmentedSubmittable<
				(
					messages:
						| Vec<IbcProtoGoogleProtobufAny>
						| (
								| IbcProtoGoogleProtobufAny
								| { typeUrl?: any; value?: any }
								| string
								| Uint8Array
						  )[],
				) => SubmittableExtrinsic<ApiType>,
		...
		ics20Transfer: {
			 ...
			 * The relevant events are emitted when successful.
			 **/
			rawTransfer: AugmentedSubmittable<
				(
					messages:
						| Vec<IbcProtoGoogleProtobufAny>
						| (
		...
		issue: {
			...
			cancelIssue: AugmentedSubmittable<
				(issueId: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[H256]
			>;
			/**
			...
			executeIssue: AugmentedSubmittable<
				(
					issueId: H256 | string | Uint8Array,
					uncheckedTransaction:
						| BitcoinFullTransactionProof
						| { userTxProof?: any; coinbaseProof?: any }
						| string
						| Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[H256, BitcoinFullTransactionProof]
			>;
			/**
			...
			requestIssue: AugmentedSubmittable<
				...
				[Compact<u128>, InterbtcPrimitivesVaultId, InterbtcPrimitivesCurrencyId]
			>;
			/**
			 ...
			 * # Weight: `O(1)`
			 **/
			setIssuePeriod: AugmentedSubmittable<
		...
		loans: {
			 ...
			 **/
			activateMarket: AugmentedSubmittable<
				(
					assetId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
			 ...
			 **/
			addMarket: AugmentedSubmittable<
				(
					assetId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
				...
				[InterbtcPrimitivesCurrencyId, LoansMarket]
			>;
			/**
			 ...
			 **/
			addReserves: AugmentedSubmittable<
				(
					payer:
						| MultiAddress
						| { Id: any }
					...
					assetId:
						...
						| string
						| Uint8Array,
					addAmount: Compact<u128> | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[MultiAddress, InterbtcPrimitivesCurrencyId, Compact<u128>]
			>;
			/**
			 ...
			 **/
			addReward: AugmentedSubmittable<
				(
					amount: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[u128]
			...
			borrow: AugmentedSubmittable<
				(
					assetId:
						...
						| string
						| Uint8Array,
					borrowAmount: Compact<u128> | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesCurrencyId, Compact<u128>]
			>;
			/**
			 ...
			 **/
			claimRewardForMarket: AugmentedSubmittable<
				(
					assetId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
			 ...
			 **/
			depositAllCollateral: AugmentedSubmittable<
				(
					assetId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
			 ...
			 * - `market`: Configuration of the new lending market
			 **/
			forceUpdateMarket: AugmentedSubmittable<
				(
					assetId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
			 ...
			 **/
			liquidateBorrow: AugmentedSubmittable<
				(
					...
					liquidationAssetId:
						...
						| string
						| Uint8Array,
					repayAmount: Compact<u128> | AnyNumber | Uint8Array,
					collateralAssetId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
						| { ForeignAsset: any }
			...
			mint: AugmentedSubmittable<
				(
					assetId:
						...
						| string
						| Uint8Array,
					mintAmount: Compact<u128> | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesCurrencyId, Compact<u128>]
			>;
			/**
			...
			redeem: AugmentedSubmittable<
				(
					assetId:
						...
						| string
						| Uint8Array,
					redeemAmount: Compact<u128> | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesCurrencyId, Compact<u128>]
			>;
			/**
			 ...
			 * - `asset_id`: the asset to be redeemed.
			 **/
			redeemAll: AugmentedSubmittable<
				(
					assetId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
			 ...
			 **/
			reduceIncentiveReserves: AugmentedSubmittable<
				(
					receiver:
						| MultiAddress
						| { Id: any }
			 ...
			 **/
			reduceReserves: AugmentedSubmittable<
				(
					receiver:
						| MultiAddress
						| { Id: any }
					...
					assetId:
						...
						| string
						| Uint8Array,
					reduceAmount: Compact<u128> | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[MultiAddress, InterbtcPrimitivesCurrencyId, Compact<u128>]
			>;
			/**
			 ...
			 * - `asset_id`: the asset to be repaid.
			 **/
			repayBorrowAll: AugmentedSubmittable<
				(
					assetId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
			...
			updateMarket: AugmentedSubmittable<
				(
					...
					liquidateIncentive:
						...
						| u128
						| AnyNumber,
					supplyCap: Option<u128> | null | Uint8Array | u128 | AnyNumber,
					borrowCap: Option<u128> | null | Uint8Array | u128 | AnyNumber,
				) => SubmittableExtrinsic<ApiType>,
				[
					InterbtcPrimitivesCurrencyId,
					Option<Permill>,
			...
			updateMarketRewardSpeed: AugmentedSubmittable<
				...
				[InterbtcPrimitivesCurrencyId, Option<u128>, Option<u128>]
			>;
			/**
			 ...
			 **/
			updateRateModel: AugmentedSubmittable<
				(
					assetId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
				...
				[InterbtcPrimitivesCurrencyId, LoansRateModelInterestRateModel]
			>;
			/**
			 ...
			 **/
			withdrawAllCollateral: AugmentedSubmittable<
				(
					assetId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
		...
		nomination: {
			depositCollateral: AugmentedSubmittable<
				...
				[InterbtcPrimitivesVaultId, u128]
			>;
			/**
			 * Allow nomination for this vault
			 **/
			optInToNomination: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
			 ...
			 **/
			optOutOfNomination: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
				...
				[InterbtcPrimitivesVaultCurrencyPair]
			>;
			setNominationEnabled: AugmentedSubmittable<
				(enabled: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[bool]
			>;
			setNominationLimit: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
						| string
						| Uint8Array,
					limit: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesVaultCurrencyPair, u128]
			>;
			withdrawCollateral: AugmentedSubmittable<
				...
				[InterbtcPrimitivesVaultId, Option<u128>, Option<u32>]
			>;
			/**
			 * Generic tx
			 **/
		...
		oracle: {
			...
			feedValues: AugmentedSubmittable<
				(
					values:
						| Vec<ITuple<[InterbtcPrimitivesOracleKey, u128]>>
						| [
								(
									| InterbtcPrimitivesOracleKey
									| { ExchangeRate: any }
			 ...
			 **/
			insertAuthorizedOracle: AugmentedSubmittable<
				(
			 ...
			 * * `account_id` - the account Id of the oracle
			 **/
			removeAuthorizedOracle: AugmentedSubmittable<
				(
					accountId: AccountId32 | string | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[AccountId32]
		...
		proxy: {
			...
			addProxy: AugmentedSubmittable<
				...
				[MultiAddress, GgxchainRuntimeBrooklynPosProxyType, u32]
			>;
			/**
			...
			createPure: AugmentedSubmittable<
				...
				[GgxchainRuntimeBrooklynPosProxyType, u32, u16]
			>;
			/**
			...
			proxy: AugmentedSubmittable<
				(
					real:
						...
						| Uint8Array,
					forceProxyType:
						| Option<GgxchainRuntimeBrooklynPosProxyType>
						| null
						| Uint8Array
						| GgxchainRuntimeBrooklynPosProxyType
						| "Any"
				...
				[MultiAddress, Option<GgxchainRuntimeBrooklynPosProxyType>, Call]
			>;
			/**
		...
		redeem: {
			...
			cancelRedeem: AugmentedSubmittable<
				(
					redeemId: H256 | string | Uint8Array,
			 ...
			 **/
			liquidationRedeem: AugmentedSubmittable<
				(
					currencies:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
						| string
						| Uint8Array,
					amountWrapped: Compact<u128> | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesVaultCurrencyPair, Compact<u128>]
			>;
			/**
			 ...
			 * # Weight: `O(1)`
			 **/
			mintTokensForReimbursedRedeem: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
				...
				[InterbtcPrimitivesVaultCurrencyPair, H256]
			>;
			/**
			...
			requestRedeem: AugmentedSubmittable<
				...
				[Compact<u128>, BitcoinAddress, InterbtcPrimitivesVaultId]
			>;
			selfRedeem: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
						| string
						| Uint8Array,
					amountWrapped: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesVaultCurrencyPair, u128]
			>;
			/**
			 ...
			 * # Weight: `O(1)`
			 **/
			setRedeemPeriod: AugmentedSubmittable<
				(period: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[u32]
			>;
			/**
		...
		replace: {
			 ...
			 **/
			acceptReplace: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
					...
					oldVault:
						...
						| string
						| Uint8Array,
					amountBtc: Compact<u128> | AnyNumber | Uint8Array,
					collateral: Compact<u128> | AnyNumber | Uint8Array,
					btcAddress:
						| BitcoinAddress
						| { P2PKH: any }
						| { P2SH: any }
			 ...
			 **/
			cancelReplace: AugmentedSubmittable<
				(
					replaceId: H256 | string | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[H256]
			>;
			/**
			 ...
			 **/
			executeReplace: AugmentedSubmittable<
				(
					replaceId: H256 | string | Uint8Array,
					uncheckedTransaction:
						| BitcoinFullTransactionProof
			 ...
			 * * `griefing_collateral` - amount of collateral
			 **/
			requestReplace: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
			 ...
			 * # Weight: `O(1)`
			 **/
			setReplacePeriod: AugmentedSubmittable<
				(period: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[u32]
			>;
			/**
			 ...
			 **/
			withdrawReplace: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
		...
		security: {
			 ...
			 **/
			activateCounter: AugmentedSubmittable<
				(
					isActive: bool | boolean | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[bool]
			>;
			/**
		...
		session: {
			...
			setKeys: AugmentedSubmittable<
				(
					keys:
						| GgxchainRuntimeBrooklynOpaqueSessionKeys
						| { aura?: any; grandpa?: any; imOnline?: any; beefy?: any }
						| string
						| Uint8Array,
					proof: Bytes | string | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[GgxchainRuntimeBrooklynOpaqueSessionKeys, Bytes]
			>;
			/**
			 * Generic tx
			 **/
		...
		sessionPayout: {
			changeValidatorToNominatorCommissionAlgorithm: AugmentedSubmittable<
				(
					algorithm:
						| RuntimeCommonPosSessionPayoutValidatorCommissionAlgorithm
						| { Static: any }
		...
		society: {
			 ...
			 * - M (len of members)
			 **/
			defenderVote: AugmentedSubmittable<
				(approve: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[bool]
			>;
			/**
			 * Found the society.
			...
			judgeSuspendedCandidate: AugmentedSubmittable<
				...
				[MultiAddress, PalletSocietyJudgement]
			>;
			/**
			...
			judgeSuspendedMember: AugmentedSubmittable<
				(
					who:
						...
						| string
						| Uint8Array,
					forgive: bool | boolean | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[MultiAddress, bool]
			>;
			/**
			 ...
			 * - O(1)
			 **/
			setMaxMembers: AugmentedSubmittable<
			 ...
			 * - X (balance unreserve)
			 **/
			unbid: AugmentedSubmittable<
				(pos: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
				[u32]
			>;
			/**
			...
			vouch: AugmentedSubmittable<
				(
					who:
						...
						| Uint8Array,
					value: u128 | AnyNumber | Uint8Array,
					tip: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[MultiAddress, u128, u128]
			>;
			/**
			 * Generic tx
			 **/
		...
		staking: {
			 ...
			 * - Weight: O(1)
			 **/
			forceNewEra: AugmentedSubmittable<
				() => SubmittableExtrinsic<ApiType>,
				[]
			>;
			/**
			 ...
			 * - Weight: O(1)
			 **/
			forceNoEras: AugmentedSubmittable<
				() => SubmittableExtrinsic<ApiType>,
				[]
			>;
			/**
		...
		tokens: {
			...
			transferAll: AugmentedSubmittable<
				...
				[MultiAddress, InterbtcPrimitivesCurrencyId, bool]
			>;
			/**
		...
		utility: {
			...
			dispatchAs: AugmentedSubmittable<
				...
				[GgxchainRuntimeBrooklynOriginCaller, Call]
			>;
			/**
			 * Send a batch of dispatch calls.
		...
		vaultRegistry: {
			 ...
			 * # Weight: `O(1)`
			 **/
			acceptNewIssues: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
						| string
						| Uint8Array,
					acceptNewIssues: bool | boolean | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesVaultCurrencyPair, bool]
			>;
			/**
			 ...
			 **/
			recoverVaultId: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
			 ...
			 **/
			registerPublicKey: AugmentedSubmittable<
				(
					publicKey: BitcoinAddressPublicKey | string | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[BitcoinAddressPublicKey]
			>;
			/**
			...
			registerVault: AugmentedSubmittable<
				...
				[InterbtcPrimitivesVaultCurrencyPair, Compact<u128>]
			>;
			reportUndercollateralizedVault: AugmentedSubmittable<
				(
					vaultId:
						| InterbtcPrimitivesVaultId
						| { accountId?: any; currencies?: any }
			 ...
			 * # Weight: `O(1)`
			 **/
			setCustomSecureThreshold: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
						| string
						| Uint8Array,
					customThreshold: Option<u128> | null | Uint8Array | u128 | AnyNumber,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesVaultCurrencyPair, Option<u128>]
			>;
			/**
			 ...
			 **/
			setLiquidationCollateralThreshold: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
						| string
						| Uint8Array,
					threshold: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesVaultCurrencyPair, u128]
			>;
			/**
			 ...
			 **/
			setMinimumCollateral: AugmentedSubmittable<
				(
					currencyId:
						| InterbtcPrimitivesCurrencyId
						| { Token: any }
						...
						| string
						| Uint8Array,
					minimum: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesCurrencyId, u128]
			>;
			/**
			 ...
			 * * `ceiling` - the new collateral ceiling
			 **/
			setPremiumRedeemThreshold: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
			 ...
			 **/
			setSecureCollateralThreshold: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
			 ...
			 * * `ceiling` - the new collateral ceiling
			 **/
			setSystemCollateralCeiling: AugmentedSubmittable<
				(
					currencyPair:
						| InterbtcPrimitivesVaultCurrencyPair
						| { collateral?: any; wrapped?: any }
						| string
						| Uint8Array,
					ceiling: u128 | AnyNumber | Uint8Array,
				) => SubmittableExtrinsic<ApiType>,
				[InterbtcPrimitivesVaultCurrencyPair, u128]
			>;
			/**
