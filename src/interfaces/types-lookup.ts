...
declare module "@polkadot/types/lookup" {
	...
	interface RuntimeCommonPosCurrencyPalletCall extends Enum {
		...
		readonly type:
			...
			| "ChangeInflationDecay"
			| "YearlyInflationDecay"
			| "ChangeTreasuryCommission"
			| "ChangeTreasuryCommissionFromFee"
			| "ChangeTreasuryCommissionFromTips";
	}
	...
	interface RuntimeCommonPosSessionPayoutValidatorCommissionAlgorithm
		extends Enum {
	...
	interface EthTypesEth2SyncCommitteePublicKeys
		extends Vec<EthTypesEth2PublicKeyBytes> {}
	...
	interface FeeCall extends Enum {
		...
		readonly type:
			| "WithdrawRewards"
			| "SetIssueFee"
			| "SetIssueGriefingCollateral"
			| "SetRedeemFee"
			| "SetPremiumRedeemFee"
			| "SetPunishmentFee"
			| "SetReplaceGriefingCollateral"
			| "SetCommission";
	}
	...
	interface VaultRegistryCall extends Enum {
		...
		readonly type:
			...
			| "ReportUndercollateralizedVault"
			| "SetMinimumCollateral"
			| "SetSystemCollateralCeiling"
	...
	interface LoansCall extends Enum {
		...
		readonly type:
			...
			| "ForceUpdateMarket"
			| "AddReward"
			| "UpdateMarketRewardSpeed"
			| "ClaimReward"
			| "ClaimRewardForMarket"
			| "Mint"
			| "Redeem"
			| "RedeemAll"
			| "Borrow"
			| "RepayBorrow"
			| "RepayBorrowAll"
			| "DepositAllCollateral"
			| "WithdrawAllCollateral"
			| "LiquidateBorrow"
			| "AddReserves"
			| "ReduceReserves"
			| "ReduceIncentiveReserves";
	}
	...
	interface RuntimeCommonPosCurrencyPalletEvent extends Enum {
		...
		readonly type:
			| "InflationPercentChanged"
			| "InflationDecayChanged"
			| "TreasuryCommissionChanged"
			| "TreasuryCommissionFromFeeChanged"
			| "TreasuryCommissionFromTipsChanged";
	}
	...
	interface IbcCoreIcs03ConnectionEventsOpenInit
		extends IbcCoreIcs03ConnectionEventsAttributes {}
	...
	interface IbcCoreIcs03ConnectionEventsOpenTry
		extends IbcCoreIcs03ConnectionEventsAttributes {}

	/** @name IbcCoreIcs03ConnectionEventsOpenAck (470) */
	interface IbcCoreIcs03ConnectionEventsOpenAck
		extends IbcCoreIcs03ConnectionEventsAttributes {}

	/** @name IbcCoreIcs03ConnectionEventsOpenConfirm (471) */
	interface IbcCoreIcs03ConnectionEventsOpenConfirm
		extends IbcCoreIcs03ConnectionEventsAttributes {}
	...
	interface IbcCoreIcs04ChannelEventsChannelAttributesCounterpartyChannelIdAttribute
		extends Struct {
	...
	interface IbcCoreIcs04ChannelEventsPacketAttributesPacketDataAttribute
		extends Struct {
		readonly packetData: Bytes;
	}

	/** @name IbcCoreIcs04ChannelEventsPacketAttributesTimeoutHeightAttribute (489) */
	interface IbcCoreIcs04ChannelEventsPacketAttributesTimeoutHeightAttribute
		extends Struct {
	...
	interface IbcCoreIcs04ChannelEventsPacketAttributesTimeoutTimestampAttribute
		extends Struct {
	...
	interface IbcCoreIcs04ChannelEventsPacketAttributesPacketConnectionIdAttribute
		extends Struct {
		readonly connectionId: Text;
	}
	...
	interface IbcCoreIcs04ChannelEventsPacketAttributesAcknowledgementAttribute
		extends Struct {
