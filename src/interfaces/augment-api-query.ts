...
import type { BTreeSet, Bytes, Null, Option, Text, U256, U8aFixed, Vec, WrapperOpaque, bool, i128, u128, u16, u32, u64 } from '@polkadot/types-codec';
import type { AnyNumber, ITuple } from '@polkadot/types-codec/types';
import type { AccountId32, H160, H256, Perbill, Percent, Permill } from '@polkadot/types/interfaces/runtime';
import type { BitcoinAddress, BitcoinAddressPublicKey, BitcoinBlockChain, BitcoinH256Le, BtcRelayRichBlockHeader, ClientsInfoClientRelease, EthTypesClientMode, EthTypesEth2ExtendedBeaconBlockHeader, EthTypesEth2SyncCommittee, EthTypesExecutionHeaderInfo, EthereumBlock, EthereumReceiptReceiptV3, EthereumTransactionTransactionV2, FeeVersion, FpRpcTransactionStatus, FrameSupportDispatchPerDispatchClassWeight, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, GgxchainRuntimeBrooklynOpaqueSessionKeys, IbcCoreIcs02ClientHeight, IbcCoreIcs03ConnectionConnectionSealedConnectionEnd, IbcCoreIcs04ChannelChannelChannelEnd, IbcCoreIcs04ChannelPacketReceipt, IbcCoreIcs24HostPathAcksPath, IbcCoreIcs24HostPathChannelEndsPath, IbcCoreIcs24HostPathClientConsensusStatePath, IbcCoreIcs24HostPathCommitmentsPath, IbcCoreIcs24HostPathReceiptsPath, IbcCoreIcs24HostPathSeqAcksPath, IbcCoreIcs24HostPathSeqRecvsPath, IbcCoreIcs24HostPathSeqSendsPath, IbcEventsIbcEvent, InterbtcPrimitivesCurrencyId, InterbtcPrimitivesIssueIssueRequest, InterbtcPrimitivesOracleKey, InterbtcPrimitivesRedeemRedeemRequest, InterbtcPrimitivesReplaceReplaceRequest, InterbtcPrimitivesVaultCurrencyPair, InterbtcPrimitivesVaultId, IssueVersion, LoansBorrowSnapshot, LoansMarket, LoansRewardMarketState, LoansVersions, OracleTimestampedValue, OracleVersion, OrmlTokensAccountData, OrmlTokensBalanceLock, OrmlTokensReserveData, OrmlTraitsAssetRegistryAssetMetadata, PalletAssetsApproval, PalletAssetsAssetAccount, PalletAssetsAssetDetails, PalletAssetsAssetMetadata, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesIdAmount, PalletBalancesReserveData, PalletBountiesBounty, PalletContractsStorageContractInfo, PalletContractsStorageDeletionQueueManager, PalletContractsWasmOwnerInfo, PalletContractsWasmPrefabWasmModule, PalletConvictionVotingVoteVoting, PalletDexOrder, PalletDexTokenInfo, PalletElectionProviderMultiPhasePhase, PalletElectionProviderMultiPhaseReadySolution, PalletElectionProviderMultiPhaseRoundSnapshot, PalletElectionProviderMultiPhaseSignedSignedSubmission, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletEvmCodeMetadata, PalletGrandpaStoredPendingChange, PalletGrandpaStoredState, PalletIcs20TransferDenomPrefixedDenom, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletImOnlineBoundedOpaqueNetworkState, PalletImOnlineSr25519AppSr25519Public, PalletMultisigMultisig, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletReferendaReferendumInfo, PalletSchedulerScheduled, PalletSocietyBid, PalletSocietyBidKind, PalletSocietyVote, PalletSocietyVouchingStatus, PalletStakingActiveEraInfo, PalletStakingEraRewardPoints, PalletStakingExposure, PalletStakingForcing, PalletStakingNominations, PalletStakingRewardDestination, PalletStakingSlashingSlashingSpans, PalletStakingSlashingSpanRecord, PalletStakingStakingLedger, PalletStakingUnappliedSlash, PalletStakingValidatorPrefs, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletVestingReleases, PalletVestingVestingInfo, RedeemVersion, ReplaceVersion, RuntimeCommonChainSpecRuntimeConfig, RuntimeCommonPosSessionPayoutValidatorCommissionAlgorithm, SpConsensusAuraSr25519AppSr25519Public, SpConsensusBeefyCryptoPublic, SpConsensusBeefyMmrBeefyAuthoritySet, SpCoreCryptoKeyTypeId, SpNposElectionsElectionScore, SpRuntimeDigest, SpStakingOffenceOffenceDetails, TypesPrimitivesH160, TypesPrimitivesH256, TypesReceiptLog, VaultRegistrySystemVault, VaultRegistryVault, VaultRegistryVersion, WebbConsensusTypesNetworkConfig, WebbProposalsHeaderTypedChainId, XcmV3MultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    accountFilter: {
      allowedAccountList: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<Null>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      allowedAccounts: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      votes: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<Null>>, [AccountId32, AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32, AccountId32]>;
      votesForAccount: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<u128>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
    ...
    assetRegistry: {
       ...
       **/
      lastAssetId: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Maps a multilocation to an asset id - useful when processing xcm
       * messages.
       **/
      locationToAssetId: AugmentedQuery<ApiType, (arg: XcmV3MultiLocation | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<u32>>, [XcmV3MultiLocation]> & QueryableStorageEntry<ApiType, [XcmV3MultiLocation]>;
      /**
    ...
    beefy: {
       ...
       **/
      authorities: AugmentedQuery<ApiType, () => Observable<Vec<SpConsensusBeefyCryptoPublic>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      nextAuthorities: AugmentedQuery<ApiType, () => Observable<Vec<SpConsensusBeefyCryptoPublic>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    btcRelay: {
       ...
       **/
      bestBlock: AugmentedQuery<ApiType, () => Observable<BitcoinH256Le>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Store the height of the best block
       **/
      bestBlockHeight: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Store Bitcoin block headers
       **/
      blockHeaders: AugmentedQuery<ApiType, (arg: BitcoinH256Le | { content?: any } | string | Uint8Array) => Observable<BtcRelayRichBlockHeader>, [BitcoinH256Le]> & QueryableStorageEntry<ApiType, [BitcoinH256Le]>;
      /**
       * Increment-only counter used to track new BlockChain entries
       **/
      chainCounter: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      chains: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Stores a mapping from (chain_index, block_height) to block hash
       **/
      chainsHashes: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<BitcoinH256Le>, [u32, u32]> & QueryableStorageEntry<ApiType, [u32, u32]>;
      /**
       ...
       **/
      chainsIndex: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<BitcoinBlockChain>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Whether the module should perform difficulty checks.
       **/
      disableDifficultyCheck: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Whether the module should perform inclusion checks.
       **/
      disableInclusionCheck: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Global security parameter k for stable Bitcoin transactions
       **/
      stableBitcoinConfirmations: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Global security parameter k for stable Parachain transactions
       **/
      stableParachainConfirmations: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * BTC height when the relay was initialized
       **/
      startBlockHeight: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    currencyManager: {
      inflationDecay: AugmentedQuery<ApiType, () => Observable<Perbill>, []> & QueryableStorageEntry<ApiType, []>;
      inflationPercent: AugmentedQuery<ApiType, () => Observable<Perbill>, []> & QueryableStorageEntry<ApiType, []>;
      lastInflationDecay: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      treasuryCommission: AugmentedQuery<ApiType, () => Observable<Perbill>, []> & QueryableStorageEntry<ApiType, []>;
      treasuryCommissionFromFee: AugmentedQuery<ApiType, () => Observable<Perbill>, []> & QueryableStorageEntry<ApiType, []>;
      treasuryCommissionFromTips: AugmentedQuery<ApiType, () => Observable<Perbill>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    dex: {
      nativeAssetId: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      nextOrderIndex: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      nextPairOrderIndex: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      orderExpiration: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<u64>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      orders: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<PalletDexOrder>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      pairOrders: AugmentedQuery<ApiType, (arg: ITuple<[u32, u32]> | [u32 | AnyNumber | Uint8Array, u32 | AnyNumber | Uint8Array]) => Observable<Vec<u64>>, [ITuple<[u32, u32]>]> & QueryableStorageEntry<ApiType, [ITuple<[u32, u32]>]>;
      tokenIndex: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<u64>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      tokenInfoes: AugmentedQuery<ApiType, () => Observable<Vec<u32>>, []> & QueryableStorageEntry<ApiType, []>;
      userOrders: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Null>, [AccountId32, u64]> & QueryableStorageEntry<ApiType, [AccountId32, u64]>;
      userTokenInfoes: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<PalletDexTokenInfo>, [AccountId32, u32]> & QueryableStorageEntry<ApiType, [AccountId32, u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    ethReceiptRegistry: {
       ...
       **/
      processedReceipts: AugmentedQuery<ApiType, (arg1: WebbProposalsHeaderTypedChainId | { None: any } | { Evm: any } | { Substrate: any } | { PolkadotParachain: any } | { KusamaParachain: any } | { RococoParachain: any } | { Cosmos: any } | { Solana: any } | { Ink: any } | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array, arg3: TypesPrimitivesH256 | string | Uint8Array) => Observable<Option<Vec<TypesReceiptLog>>>, [WebbProposalsHeaderTypedChainId, u64, TypesPrimitivesH256]> & QueryableStorageEntry<ApiType, [WebbProposalsHeaderTypedChainId, u64, TypesPrimitivesH256]>;
      /**
       * querying that the inclusion-proof for a receipt has been processed or not
       **/
      processedReceiptsHash: AugmentedQuery<ApiType, (arg1: WebbProposalsHeaderTypedChainId | { None: any } | { Evm: any } | { Substrate: any } | { PolkadotParachain: any } | { KusamaParachain: any } | { RococoParachain: any } | { Cosmos: any } | { Solana: any } | { Ink: any } | string | Uint8Array, arg2: TypesPrimitivesH256 | string | Uint8Array) => Observable<Option<Null>>, [WebbProposalsHeaderTypedChainId, TypesPrimitivesH256]> & QueryableStorageEntry<ApiType, [WebbProposalsHeaderTypedChainId, TypesPrimitivesH256]>;
      /**
       * pay validator proof deposit
       **/
      proofDeposit: AugmentedQuery<ApiType, (arg: WebbProposalsHeaderTypedChainId | { None: any } | { Evm: any } | { Substrate: any } | { PolkadotParachain: any } | { KusamaParachain: any } | { RococoParachain: any } | { Cosmos: any } | { Solana: any } | { Ink: any } | string | Uint8Array) => Observable<u128>, [WebbProposalsHeaderTypedChainId]> & QueryableStorageEntry<ApiType, [WebbProposalsHeaderTypedChainId]>;
      /**
       ...
       **/
      watchedContracts: AugmentedQuery<ApiType, (arg: WebbProposalsHeaderTypedChainId | { None: any } | { Evm: any } | { Substrate: any } | { PolkadotParachain: any } | { KusamaParachain: any } | { RococoParachain: any } | { Cosmos: any } | { Solana: any } | { Ink: any } | string | Uint8Array) => Observable<Option<Vec<TypesPrimitivesH160>>>, [WebbProposalsHeaderTypedChainId]> & QueryableStorageEntry<ApiType, [WebbProposalsHeaderTypedChainId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    fee: {
       ...
       **/
      commission: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array) => Observable<Option<u128>>, [InterbtcPrimitivesVaultId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultId]>;
      /**
       * # Issue
       ...
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<FeeVersion>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    ibc: {
       ...
       **/
      acknowledgements: AugmentedQuery<ApiType, (arg: IbcCoreIcs24HostPathAcksPath | { portId?: any; channelId?: any; sequence?: any } | string | Uint8Array) => Observable<Option<Bytes>>, [IbcCoreIcs24HostPathAcksPath]> & QueryableStorageEntry<ApiType, [IbcCoreIcs24HostPathAcksPath]>;
      /**
       * channel counter
       **/
      channelCounter: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * key: CHannelEndsPath
       * value: ChannelEnd
       **/
      channels: AugmentedQuery<ApiType, (arg: IbcCoreIcs24HostPathChannelEndsPath) => Observable<Option<IbcCoreIcs04ChannelChannelChannelEnd>>, [IbcCoreIcs24HostPathChannelEndsPath]> & QueryableStorageEntry<ApiType, [IbcCoreIcs24HostPathChannelEndsPath]>;
      /**
       * key: connection_id
       * value: Vec<(port_id, channel_id)>
       **/
      channelsConnection: AugmentedQuery<ApiType, (arg: Text | string) => Observable<Option<Vec<ITuple<[Text, Text]>>>>, [Text]> & QueryableStorageEntry<ApiType, [Text]>;
      /**
       * client counter
       **/
      clientCounter: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * key1: client_id
       * key2: height
       * value: host_height
       **/
      clientProcessedHeights: AugmentedQuery<ApiType, (arg1: Text | string, arg2: IbcCoreIcs02ClientHeight | { revisionNumber?: any; revisionHeight?: any } | string | Uint8Array) => Observable<Option<IbcCoreIcs02ClientHeight>>, [Text, IbcCoreIcs02ClientHeight]> & QueryableStorageEntry<ApiType, [Text, IbcCoreIcs02ClientHeight]>;
      /**
       * key1: client_id
       * key2: height
       * value: timestamp
       **/
      clientProcessedTimes: AugmentedQuery<ApiType, (arg1: Text | string, arg2: IbcCoreIcs02ClientHeight | { revisionNumber?: any; revisionHeight?: any } | string | Uint8Array) => Observable<Option<u64>>, [Text, IbcCoreIcs02ClientHeight]> & QueryableStorageEntry<ApiType, [Text, IbcCoreIcs02ClientHeight]>;
      /**
       * key: ClientTypePath
       * value: ClientType
       **/
      clients: AugmentedQuery<ApiType, (arg: Text | string) => Observable<Option<Text>>, [Text]> & QueryableStorageEntry<ApiType, [Text]>;
      /**
       * Key: ClientStatePath
       * value: ClientState
       **/
      clientStates: AugmentedQuery<ApiType, (arg: Text | string) => Observable<Option<Bytes>>, [Text]> & QueryableStorageEntry<ApiType, [Text]>;
      /**
       * key: ClientId
       * value: ConnectionId
       **/
      connectionClient: AugmentedQuery<ApiType, (arg: Text | string) => Observable<Option<Text>>, [Text]> & QueryableStorageEntry<ApiType, [Text]>;
      /**
       * connection counter
       **/
      connectionCounter: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * key: ConnectionsPath
       * value: ConnectionEnd
       **/
      connections: AugmentedQuery<ApiType, (arg: Text | string) => Observable<Option<IbcCoreIcs03ConnectionConnectionSealedConnectionEnd>>, [Text]> & QueryableStorageEntry<ApiType, [Text]>;
      /**
       * key: ClientConsensusStatePath
       * value: ConsensusState
       **/
      consensusStates: AugmentedQuery<ApiType, (arg: IbcCoreIcs24HostPathClientConsensusStatePath | { clientId?: any; epoch?: any; height?: any } | string | Uint8Array) => Observable<Option<Bytes>>, [IbcCoreIcs24HostPathClientConsensusStatePath]> & QueryableStorageEntry<ApiType, [IbcCoreIcs24HostPathClientConsensusStatePath]>;
      /**
       * key: height
       * value: Ibc event height
       **/
      ibcEventStore: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<IbcEventsIbcEvent>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
       * key: SeqAcksPath
       * value: sequence
       **/
      nextSequenceAck: AugmentedQuery<ApiType, (arg: IbcCoreIcs24HostPathSeqAcksPath) => Observable<Option<u64>>, [IbcCoreIcs24HostPathSeqAcksPath]> & QueryableStorageEntry<ApiType, [IbcCoreIcs24HostPathSeqAcksPath]>;
      /**
       * key: SeqRecvsPath
       * value: sequence
       **/
      nextSequenceRecv: AugmentedQuery<ApiType, (arg: IbcCoreIcs24HostPathSeqRecvsPath) => Observable<Option<u64>>, [IbcCoreIcs24HostPathSeqRecvsPath]> & QueryableStorageEntry<ApiType, [IbcCoreIcs24HostPathSeqRecvsPath]>;
      /**
       * Key: SeqSendsPath
       * value: sequence
       **/
      nextSequenceSend: AugmentedQuery<ApiType, (arg: IbcCoreIcs24HostPathSeqSendsPath) => Observable<Option<u64>>, [IbcCoreIcs24HostPathSeqSendsPath]> & QueryableStorageEntry<ApiType, [IbcCoreIcs24HostPathSeqSendsPath]>;
      /**
       * Previous host block height
       **/
      oldHeight: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * key: CommitmentsPath
       * value: hash of (timestamp, height, packet)
       **/
      packetCommitment: AugmentedQuery<ApiType, (arg: IbcCoreIcs24HostPathCommitmentsPath | { portId?: any; channelId?: any; sequence?: any } | string | Uint8Array) => Observable<Option<Bytes>>, [IbcCoreIcs24HostPathCommitmentsPath]> & QueryableStorageEntry<ApiType, [IbcCoreIcs24HostPathCommitmentsPath]>;
      /**
       * key: ReceiptsPath
       * value: receipt
       **/
      packetReceipt: AugmentedQuery<ApiType, (arg: IbcCoreIcs24HostPathReceiptsPath | { portId?: any; channelId?: any; sequence?: any } | string | Uint8Array) => Observable<Option<IbcCoreIcs04ChannelPacketReceipt>>, [IbcCoreIcs24HostPathReceiptsPath]> & QueryableStorageEntry<ApiType, [IbcCoreIcs24HostPathReceiptsPath]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    ics20Transfer: {
       ...
       * (asset name) => asset id
       **/
      assetIdByName: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<u32>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      denomTrace: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<Option<PalletIcs20TransferDenomPrefixedDenom>>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      /**
       * key: height
       * value: Ibc event height
       **/
      sendPacketStore: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<IbcEventsIbcEvent>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    issue: {
       ...
       **/
      issueBtcDustValue: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      issueRequests: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<InterbtcPrimitivesIssueIssueRequest>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Build storage at V1 (requires default 0).
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<IssueVersion>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    loans: {
       ...
       **/
      accountBorrows: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<LoansBorrowSnapshot>, [InterbtcPrimitivesCurrencyId, AccountId32]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId, AccountId32]>;
      /**
       ...
       **/
      accountDeposits: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId, AccountId32]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId, AccountId32]>;
      /**
       * Accumulator of the total earned interest rate since the opening of the market
       * CurrencyId -> u128
       **/
      borrowIndex: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Mapping of borrow rate to currency type
       **/
      borrowRate: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * The internal exchange rate from the associated lend token to the underlying currency.
       **/
      exchangeRate: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * The timestamp of the last calculation of accrued interest
       **/
      lastAccruedInterestTime: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u64>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Mapping of underlying currency id to its market
       **/
      markets: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<Option<LoansMarket>>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * The maximum allowed exchange rate for a market.
       **/
      maxExchangeRate: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The minimum allowed exchange rate for a market. This is the starting rate when a market is first set up.
       **/
      minExchangeRate: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The incentive reward accrued but not yet transferred to each user.
       **/
      rewardAccrued: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<u128>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * The incentive reward index for each market for each borrower as of the last time they accrued Reward
       **/
      rewardBorrowerIndex: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId, AccountId32]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId, AccountId32]>;
      /**
       * Mapping of underlying currency id to borrow reward speed
       **/
      rewardBorrowSpeed: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * The Reward market borrow state for each market
       **/
      rewardBorrowState: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<LoansRewardMarketState>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * The incentive reward index for each market for each supplier as of the last time they accrued Reward
       **/
      rewardSupplierIndex: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId, AccountId32]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId, AccountId32]>;
      /**
       * Mapping of underlying currency id to supply reward speed
       **/
      rewardSupplySpeed: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * The Reward market supply state for each market
       **/
      rewardSupplyState: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<LoansRewardMarketState>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Storage version of the pallet.
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<LoansVersions>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Mapping of supply rate to currency type
       **/
      supplyRate: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Total amount of outstanding borrows of the underlying in this market
       * CurrencyId -> Balance
       **/
      totalBorrows: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Total amount of reserves of the underlying held in this market
       * CurrencyId -> Balance
       **/
      totalReserves: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Mapping of lend_token id to underlying currency id
       * `lend_token id`: voucher token id
       * `asset id`: underlying token id
       **/
      underlyingAssetId: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<Option<InterbtcPrimitivesCurrencyId>>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Borrow utilization ratio
       **/
      utilizationRatio: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<Permill>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    nomination: {
       ...
       **/
      nominationLimit: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesVaultId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultId]>;
      /**
       * Map of Vaults who have enabled nomination
       **/
      vaults: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array) => Observable<bool>, [InterbtcPrimitivesVaultId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    oracle: {
       ...
       **/
      aggregate: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesOracleKey | { ExchangeRate: any } | { FeeEstimation: any } | string | Uint8Array) => Observable<Option<u128>>, [InterbtcPrimitivesOracleKey]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesOracleKey]>;
      ...
      rawValues: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesOracleKey | { ExchangeRate: any } | { FeeEstimation: any } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<OracleTimestampedValue>>, [InterbtcPrimitivesOracleKey, AccountId32]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesOracleKey, AccountId32]>;
      /**
       * if a key is present, it means the values have been updated
       **/
      rawValuesUpdated: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesOracleKey | { ExchangeRate: any } | { FeeEstimation: any } | string | Uint8Array) => Observable<Option<bool>>, [InterbtcPrimitivesOracleKey]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesOracleKey]>;
      /**
       * Build storage at V1 (requires default 0).
       **/
       ...
       **/
      validUntil: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesOracleKey | { ExchangeRate: any } | { FeeEstimation: any } | string | Uint8Array) => Observable<Option<u64>>, [InterbtcPrimitivesOracleKey]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesOracleKey]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    redeem: {
       ...
       **/
      redeemBtcDustValue: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      redeemRequests: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<InterbtcPrimitivesRedeemRedeemRequest>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * the expected size in bytes of the redeem bitcoin transfer
       **/
      redeemTransactionSize: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Build storage at V1 (requires default 0).
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<RedeemVersion>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    replace: {
       ...
       * risk the bitcoin client to reject the payment
       **/
      replaceBtcDustValue: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      replaceRequests: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<InterbtcPrimitivesReplaceReplaceRequest>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Build storage at V1 (requires default 0).
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<ReplaceVersion>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    runtimeSpecification: {
      specification: AugmentedQuery<ApiType, () => Observable<RuntimeCommonChainSpecRuntimeConfig>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    security: {
      ...
      isDeactivated: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<GgxchainRuntimeBrooklynOpaqueSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, GgxchainRuntimeBrooklynOpaqueSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    sessionPayout: {
       ...
       **/
      lastEra: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Tracks session points change per each validator.
       **/
      lastEraPoints: AugmentedQuery<ApiType, () => Observable<PalletStakingEraRewardPoints>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Start time to calculate session reward percentage.
       **/
      sessionStartTime: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Algorithm how to calculate validator percent comission to nominators.
       **/
      validatorToNominatorCommissionAlgorithm: AugmentedQuery<ApiType, () => Observable<RuntimeCommonPosSessionPayoutValidatorCommissionAlgorithm>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Year reward pool amount to prevent compounding. It updates every year.
       **/
      yearReward: AugmentedQuery<ApiType, () => Observable<ITuple<[u128, u128]>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    tokens: {
       ...
       * balances.
       **/
      accounts: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<OrmlTokensAccountData>, [AccountId32, InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, InterbtcPrimitivesCurrencyId]>;
      /**
       * Any liquidity locks of a token type under an account.
       * NOTE: Should only be accessed when setting, changing and freeing a lock.
       **/
      locks: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<Vec<OrmlTokensBalanceLock>>, [AccountId32, InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, InterbtcPrimitivesCurrencyId]>;
      /**
       * Named reserves on some account balances.
       **/
      reserves: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<Vec<OrmlTokensReserveData>>, [AccountId32, InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, InterbtcPrimitivesCurrencyId]>;
      /**
       * The total issuance of a token type.
       **/
      totalIssuance: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    vaultCapacity: {
       ...
       **/
      rewardCurrencies: AugmentedQuery<ApiType, (arg: Null | null) => Observable<BTreeSet<InterbtcPrimitivesCurrencyId>>, [Null]> & QueryableStorageEntry<ApiType, [Null]>;
      /**
       * Used to compute the rewards for a participant's stake.
       **/
      rewardPerToken: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, arg2: Null | null) => Observable<i128>, [InterbtcPrimitivesCurrencyId, Null]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId, Null]>;
      /**
       * Accounts for previous changes in stake size.
       **/
      rewardTally: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, arg2: ITuple<[Null, InterbtcPrimitivesCurrencyId]> | [Null | null, InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array]) => Observable<i128>, [InterbtcPrimitivesCurrencyId, ITuple<[Null, InterbtcPrimitivesCurrencyId]>]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId, ITuple<[Null, InterbtcPrimitivesCurrencyId]>]>;
      /**
       * The stake of a participant in this reward pool.
       **/
      stake: AugmentedQuery<ApiType, (arg: ITuple<[Null, InterbtcPrimitivesCurrencyId]> | [Null | null, InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array]) => Observable<i128>, [ITuple<[Null, InterbtcPrimitivesCurrencyId]>]> & QueryableStorageEntry<ApiType, [ITuple<[Null, InterbtcPrimitivesCurrencyId]>]>;
      /**
       * The total unclaimed rewards distributed to this reward pool.
       * NOTE: this is currently only used for integration tests.
       **/
      totalRewards: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<i128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * The total stake deposited to this reward pool.
       **/
      totalStake: AugmentedQuery<ApiType, (arg: Null | null) => Observable<i128>, [Null]> & QueryableStorageEntry<ApiType, [Null]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    vaultRegistry: {
       ...
       **/
      liquidationCollateralThreshold: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultCurrencyPair | { collateral?: any; wrapped?: any } | string | Uint8Array) => Observable<Option<u128>>, [InterbtcPrimitivesVaultCurrencyPair]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultCurrencyPair]>;
      liquidationVault: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultCurrencyPair | { collateral?: any; wrapped?: any } | string | Uint8Array) => Observable<Option<VaultRegistrySystemVault>>, [InterbtcPrimitivesVaultCurrencyPair]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultCurrencyPair]>;
      /**
       * The minimum collateral (e.g. DOT/KSM) a Vault needs to provide to register.
       **/
      minimumCollateralVault: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       ...
       **/
      premiumRedeemThreshold: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultCurrencyPair | { collateral?: any; wrapped?: any } | string | Uint8Array) => Observable<Option<u128>>, [InterbtcPrimitivesVaultCurrencyPair]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultCurrencyPair]>;
      /**
       ...
       **/
      reservedAddresses: AugmentedQuery<ApiType, (arg: BitcoinAddress | { P2PKH: any } | { P2SH: any } | { P2WPKHv0: any } | { P2WSHv0: any } | string | Uint8Array) => Observable<Option<InterbtcPrimitivesVaultId>>, [BitcoinAddress]> & QueryableStorageEntry<ApiType, [BitcoinAddress]>;
      /**
       ...
       **/
      secureCollateralThreshold: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultCurrencyPair | { collateral?: any; wrapped?: any } | string | Uint8Array) => Observable<Option<u128>>, [InterbtcPrimitivesVaultCurrencyPair]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultCurrencyPair]>;
      /**
       * Pallet storage version
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<VaultRegistryVersion>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Determines the over-collateralization rate for collateral locked by Vaults, necessary for
       * wrapped tokens. This threshold should be greater than the LiquidationCollateralThreshold.
       **/
      systemCollateralCeiling: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultCurrencyPair | { collateral?: any; wrapped?: any } | string | Uint8Array) => Observable<Option<u128>>, [InterbtcPrimitivesVaultCurrencyPair]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultCurrencyPair]>;
      /**
       * Total collateral used for collateral tokens issued by active vaults, excluding the liquidation vault
       **/
      totalUserVaultCollateral: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultCurrencyPair | { collateral?: any; wrapped?: any } | string | Uint8Array) => Observable<u128>, [InterbtcPrimitivesVaultCurrencyPair]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultCurrencyPair]>;
      /**
       * Mapping of Vaults, using the respective Vault account identifier as key.
       **/
      vaultBitcoinPublicKey: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<BitcoinAddressPublicKey>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Mapping of Vaults, using the respective Vault account identifier as key.
       **/
      vaults: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array) => Observable<Option<VaultRegistryVault>>, [InterbtcPrimitivesVaultId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    vaultRewards: {
       ...
       * Track the currencies used for rewards.
       **/
      rewardCurrencies: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<BTreeSet<InterbtcPrimitivesCurrencyId>>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Used to compute the rewards for a participant's stake.
       **/
      rewardPerToken: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, arg2: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<i128>, [InterbtcPrimitivesCurrencyId, InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId, InterbtcPrimitivesCurrencyId]>;
      /**
       * Accounts for previous changes in stake size.
       **/
      rewardTally: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, arg2: ITuple<[InterbtcPrimitivesCurrencyId, InterbtcPrimitivesVaultId]> | [InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array]) => Observable<i128>, [InterbtcPrimitivesCurrencyId, ITuple<[InterbtcPrimitivesCurrencyId, InterbtcPrimitivesVaultId]>]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId, ITuple<[InterbtcPrimitivesCurrencyId, InterbtcPrimitivesVaultId]>]>;
      /**
       * The stake of a participant in this reward pool.
       **/
      stake: AugmentedQuery<ApiType, (arg: ITuple<[InterbtcPrimitivesCurrencyId, InterbtcPrimitivesVaultId]> | [InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array]) => Observable<i128>, [ITuple<[InterbtcPrimitivesCurrencyId, InterbtcPrimitivesVaultId]>]> & QueryableStorageEntry<ApiType, [ITuple<[InterbtcPrimitivesCurrencyId, InterbtcPrimitivesVaultId]>]>;
      /**
       * The total unclaimed rewards distributed to this reward pool.
       * NOTE: this is currently only used for integration tests.
       **/
       ...
       * The total stake deposited to this reward pool.
       **/
      totalStake: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array) => Observable<i128>, [InterbtcPrimitivesCurrencyId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    vaultStaking: {
       ...
       **/
      nonce: AugmentedQuery<ApiType, (arg: InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array) => Observable<u32>, [InterbtcPrimitivesVaultId]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesVaultId]>;
      /**
       * Used to compute the rewards for a participant's stake.
       **/
      rewardPerToken: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, arg2: ITuple<[u32, InterbtcPrimitivesVaultId]> | [u32 | AnyNumber | Uint8Array, InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array]) => Observable<i128>, [InterbtcPrimitivesCurrencyId, ITuple<[u32, InterbtcPrimitivesVaultId]>]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId, ITuple<[u32, InterbtcPrimitivesVaultId]>]>;
      /**
       * Accounts for previous changes in stake size.
       **/
      rewardTally: AugmentedQuery<ApiType, (arg1: InterbtcPrimitivesCurrencyId | { Token: any } | { ForeignAsset: any } | { LendToken: any } | { LpToken: any } | { StableLpToken: any } | string | Uint8Array, arg2: ITuple<[u32, InterbtcPrimitivesVaultId, AccountId32]> | [u32 | AnyNumber | Uint8Array, InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array, AccountId32 | string | Uint8Array]) => Observable<i128>, [InterbtcPrimitivesCurrencyId, ITuple<[u32, InterbtcPrimitivesVaultId, AccountId32]>]> & QueryableStorageEntry<ApiType, [InterbtcPrimitivesCurrencyId, ITuple<[u32, InterbtcPrimitivesVaultId, AccountId32]>]>;
      /**
       * Used to compute the amount to slash from a participant's stake.
       **/
      slashPerToken: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array) => Observable<i128>, [u32, InterbtcPrimitivesVaultId]> & QueryableStorageEntry<ApiType, [u32, InterbtcPrimitivesVaultId]>;
      /**
       * Accounts for previous changes in stake size.
       **/
      slashTally: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: ITuple<[InterbtcPrimitivesVaultId, AccountId32]> | [InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array, AccountId32 | string | Uint8Array]) => Observable<i128>, [u32, ITuple<[InterbtcPrimitivesVaultId, AccountId32]>]> & QueryableStorageEntry<ApiType, [u32, ITuple<[InterbtcPrimitivesVaultId, AccountId32]>]>;
      /**
       * The stake of a participant in this reward pool.
       **/
      stake: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: ITuple<[InterbtcPrimitivesVaultId, AccountId32]> | [InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array, AccountId32 | string | Uint8Array]) => Observable<i128>, [u32, ITuple<[InterbtcPrimitivesVaultId, AccountId32]>]> & QueryableStorageEntry<ApiType, [u32, ITuple<[InterbtcPrimitivesVaultId, AccountId32]>]>;
       ...
       **/
      totalCurrentStake: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array) => Observable<i128>, [u32, InterbtcPrimitivesVaultId]> & QueryableStorageEntry<ApiType, [u32, InterbtcPrimitivesVaultId]>;
      /**
       * The total unclaimed rewards distributed to this reward pool.
       * NOTE: this is currently only used for integration tests.
       **/
       ...
       **/
      totalStake: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: InterbtcPrimitivesVaultId | { accountId?: any; currencies?: any } | string | Uint8Array) => Observable<i128>, [u32, InterbtcPrimitivesVaultId]> & QueryableStorageEntry<ApiType, [u32, InterbtcPrimitivesVaultId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
