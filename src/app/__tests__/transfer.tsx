...
let ibcChange = jest.fn();

const keplrMock = {
    experimentalSuggestChain() { },
    enable(a: any) { ibcChange(a) },
    // @ts-ignore
    getOfflineSigner() {
        return new class A {
            async getAccounts() { return [{ address: "blahblah" }, { address: "meowmeow" }] };
        };
    },
}
...
jest.mock("../../services/ggx", () => ({
    ...
    default: class GGXService {
        ...
        pubkey(): any {
            return { address: "5G4Ug9EPQHqk5iJGjUFHeLHYCvX4JRPVrtxxFPmwuk9wj8GC", name: "Account 1" };
        }
    }
}));
