...
type ConnectedParachainProviderContextType = {
	isConnected: true;
	api: ApiPromise;
	error: string | undefined;
};

type DisconnectedParachainProviderContextType = {
	isConnected: false;
	api: undefined;
	error: string | undefined;
};
...
type ParachainProviderContextType =
	| ConnectedParachainProviderContextType
	| DisconnectedParachainProviderContextType;
